        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="heading text-4xl md:text-5xl font-bold tracking-tight text-dark mb-6">
              Accelerate Your <span className="text-primary">Startup Growth</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a href="#contact">
                <Button variant="outline" className="text-dark border-gray-300 px-6 py-3 h-auto">
                  Get in Touch
                </Button>
              </a>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-lg shadow-lg p-4 max-w-xs hidden md:block">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-dark">90% of our startups secure funding</p>
                </div>
              </div>
            </div>
          </div>
